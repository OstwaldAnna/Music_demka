...
?>
    ...
    <div class="container mt-3 text-center">
        <div class="row">
            ...
            <!-- Форма регистрации -->
            <form method="post" action="../vendor/sign_in.php">
                <div class="row g-3">
                    <div class="col-sm-4">
            ...
            <div class="form-check">
                ...
                <button class="w-50 btn btn-outline-secondary" type="submit">Зарегистрироваться</button>
            <?php 
                if ($_SESSION['message']){
        ...
        <div class="col" style="margin-left: 3rem;">
            <img src="/resources/images/11.jpeg" style="object-fit: none" alt="image" height="700" width="600">
        </div>
    </div>
</div>
